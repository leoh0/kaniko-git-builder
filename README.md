# Kaniko Git Builder Chart

* building image by kaniko from git source

## TL;DR;

```console
$ helm install leoh0/kaniko-git-builder
```
...
```console
$ helm install --name my-release leoh0/kaniko-git-builder
```
